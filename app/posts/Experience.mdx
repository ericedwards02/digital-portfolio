...
**Networks**
This class covered important topics for each layer of computer networking, from application-layer to the physical layer. I implemented a
UDP chat client and multi-server distributed network to coordinate a number of clients and servers.
